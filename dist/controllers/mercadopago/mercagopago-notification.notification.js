        ...
        this.handle = async (req, res) => {
            ...
            try {
                ...
                if (type === "payment" && (data === null || data === void 0 ? void 0 : data.id)) {
                    ...
                    const name = ((_b = paymentInfo.payer) === null || _b === void 0 ? void 0 : _b.first_name) || "Usuário";
                    ...
                    // Se o pagamento foi aprovado, envia o e-mail
                    if (status === "approved" && email) {
                        ...
                        const userEmail = data === null || data === void 0 ? void 0 : data.email;
                        const mailOptions = {
