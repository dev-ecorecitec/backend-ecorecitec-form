...
const create_newsletter_user_dto_1 = require("./dto/create-newsletter-user.dto");
class NewsletterCreateController {
    constructor() {
        ...
        this.store = async (req, res) => {
            const result = create_newsletter_user_dto_1.CreateNewsletterUserDTO.safeParse(req.body);
            if (!result.success) {
            ...
            try {
                ...
                if (!user) {
                    ...
                    console.log(`Usuário ${result.data.name} (${result.data.email}) cadastrado com sucesso.`);
                }
                else {
                    password = user.password;
                    console.log(`Usuário ${result.data.name} (${result.data.email}) já existente. Usando senha existente.`);
                }
        ...
        `,
                ...
                console.log(`E-mail enviado para ${result.data.email} com sucesso.`);
